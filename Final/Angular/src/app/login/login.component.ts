...
export class LoginComponent implements OnInit {
  ...
  constructor(private serv: LoginService, private commserve: CommonService, private router: Router, private toastr: ToastrService, public roleServ: UserroleService
  ) {
    this.modifiedtext = 2;
  }
